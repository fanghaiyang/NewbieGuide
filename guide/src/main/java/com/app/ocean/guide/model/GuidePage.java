...
public class GuidePage {
     ...
     *
     * @param resId  布局id
     * @param skipId 页面跳过按钮ID
     * @param id     布局中点击消失引导页的控件id
     */
    public GuidePage setLayoutResSkip(@LayoutRes int resId, int skipId, int... id) {
        this.layoutResId = resId;
        clickToSkipId = skipId;
        clickToDismissIds = id;
        return this;
    }
    ...
    public int getClickToSkipId() {
        return clickToSkipId;
    }
