...
import com.app.ocean.guide.lifecycle.FragmentLifecycleAdapter;
import com.app.ocean.guide.lifecycle.ListenerFragment;
import com.app.ocean.guide.lifecycle.V4ListenerFragment;
...
public class Controller {
    ...
    public void showPage(int position) {
        ...
        if (currentLayout != null) {
            ...
            currentLayout.setOnGuideLayoutSkipDismissListener(new GuideLayout.OnGuideLayoutShipDismissListener() {
                @Override
                public void onGuideLayoutShipDismiss() {
//                    System.out.println("onGuideLayoutDismiss2");
                    if (onGuideChangedListener != null) {
                        onGuideChangedListener.onSkiped();
                    }
    ...
    private void showGuidePage() {
        ...
        guideLayout.setOnGuideLayoutSkipDismissListener(new GuideLayout.OnGuideLayoutShipDismissListener() {
            @Override
            public void onGuideLayoutShipDismiss() {
//                System.out.println("onGuideLayoutDismiss233");
                if (onGuideChangedListener != null) {
                    onGuideChangedListener.onSkiped();
                }
            }
     ...
     * @param label 引导标示
     */
    public void setSkipLabel(String label) {
        int showed = sp.getInt(label, 0);
        sp.edit().putInt(label, showed + 1).apply();
    }
